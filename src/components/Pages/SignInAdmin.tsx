            ...
            <form className="w-full max-w-sm space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            className={`w-full p-3 text-lg border ${isPasswordValid ? 'border-red-600' : 'border-red-600 border-2 border-solid border-red-600'} rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600 text-black placeholder-gray-500`}
