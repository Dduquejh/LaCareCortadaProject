  ...
  return (
    <nav className="bg-black p-3 border-b-2 border-white relative">
      ...
      {(isMenuOpen || isAnimating) && (
        <div
          className={`lg:hidden absolute top-full left-0 w-full bg-black border-t border-white transition-all duration-300 ${
          ...
          <ul className="flex flex-col items-center text-white font-old-english text-[32px] space-y-4 py-4">
            ...
            <li className="border-b border-white w-full text-center">
              <Link
                ...
                className="text-gray-900 dark:text-white hover:underline"
              >
                <button className="w-full text-white hover:bg-white hover:text-black py-2">
                  Log In
                </button>
              </Link>
            </li>
